...
Import types from `@aws-lite/iam`. For plugin autoloading or string plugin names, add `import type {} from '@aws-lite/iam'` in TypeScript (or `import '@aws-lite/iam'` in JavaScript) to load the declarations.
