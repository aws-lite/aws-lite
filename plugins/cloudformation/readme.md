...
Import types from `@aws-lite/cloudformation`. For plugin autoloading or string plugin names, add `import type {} from '@aws-lite/cloudformation'` in TypeScript (or `import '@aws-lite/cloudformation'` in JavaScript) to load the declarations.
