...
export default {
  ...
  CreateStack:                       { disabled, awsDoc: docRoot + 'API_CreateStack.html' },
  ...
  DeleteStack:                       { disabled, awsDoc: docRoot + 'API_DeleteStack.html' },
  ...
  DescribeStackResources:            { disabled, awsDoc: docRoot + 'API_DescribeStackResources.html' },
  DescribeStacks:                    { disabled, awsDoc: docRoot + 'API_DescribeStacks.html' },
  ...
  ListStackResources:                { disabled, awsDoc: docRoot + 'API_ListStackResources.html' },
  ...
  UpdateStack:                       { disabled, awsDoc: docRoot + 'API_UpdateStack.html' },
