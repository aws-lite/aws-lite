...
Import types from `@aws-lite/cloudfront`. For plugin autoloading or string plugin names, add `import type {} from '@aws-lite/cloudfront'` in TypeScript (or `import '@aws-lite/cloudfront'` in JavaScript) to load the declarations.
