...
export default {
  ...
  CreateDistribution:                         { disabled, awsDoc: docRoot + 'API_CreateDistribution.html' },
  ...
  CreateInvalidation:                         { disabled, awsDoc: docRoot + 'API_CreateInvalidation.html' },
  ...
  DeleteDistribution:                         { disabled, awsDoc: docRoot + 'API_DeleteDistribution.html' },
  ...
  GetDistribution:                            { disabled, awsDoc: docRoot + 'API_GetDistribution.html' },
  GetDistributionConfig:                      { disabled, awsDoc: docRoot + 'API_GetDistributionConfig.html' },
  ...
  ListDistributions:                          { disabled, awsDoc: docRoot + 'API_ListDistributions.html' },
  ...
  UpdateDistribution:                         { disabled, awsDoc: docRoot + 'API_UpdateDistribution.html' },
