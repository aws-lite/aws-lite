...
Import types from `@aws-lite/route53`. For plugin autoloading or string plugin names, add `import type {} from '@aws-lite/route53'` in TypeScript (or `import '@aws-lite/route53'` in JavaScript) to load the declarations.
