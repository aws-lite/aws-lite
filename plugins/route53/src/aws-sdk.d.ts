// Generated from @aws-sdk/client-route-53@3.1136.0 by npm run gen. Do not edit.
...
declare const ChangeStatus: {
	readonly INSYNC: "INSYNC";
	readonly PENDING: "PENDING";
};
type ChangeStatus = (typeof ChangeStatus)[keyof typeof ChangeStatus];
declare const ResourceRecordSetFailover: {
	readonly PRIMARY: "PRIMARY";
	readonly SECONDARY: "SECONDARY";
};
type ResourceRecordSetFailover = (typeof ResourceRecordSetFailover)[keyof typeof ResourceRecordSetFailover];
declare const ResourceRecordSetRegion: {
...
type ResourceRecordSetRegion = (typeof ResourceRecordSetRegion)[keyof typeof ResourceRecordSetRegion];
declare const RRType: {
	readonly A: "A";
	readonly AAAA: "AAAA";
	readonly CAA: "CAA";
...
type RRType = (typeof RRType)[keyof typeof RRType];
...
interface GeoProximityLocation {
	/**
 ...
 */
export interface ChangeResourceRecordSetsCommandOutput extends ChangeResourceRecordSetsResponse, MetadataBearer {
}
/**
 * @public
 *
 ...
 */
export interface ListResourceRecordSetsCommandOutput extends ListResourceRecordSetsResponse, MetadataBearer {
}
