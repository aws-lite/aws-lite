...
declare interface AwsLiteCloudWatch Logs {
   ...
   */
  DescribeLogGroups: (input: { accountIdentifiers?: any[], logGroupNamePrefix?: string, logGroupNamePattern?: string, nextToken?: string, limit?: number, includeLinkedAccounts?: boolean, logGroupClass: string }) => Promise<DescribeLogGroupsResponse>
  /**
   * @description
   ...
   */
  DescribeLogStreams: (input: { descending?: boolean, limit?: number, logGroupIdentifier?: string, logGroupName?: string, logStreamNamePrefix?: string, nextToken?: string, orderBy?: string }) => Promise<DescribeLogStreamsResponse>
  /**
   * @description
   ...
   */
  GetLogEvents: (input: { endTime?: number, limit?: number, logGroupIdentifier?: string, logGroupName?: string, logStreamName?: string, nextToken?: string, startFromHead?: boolean, startTime?: number, unmask?: boolean }) => Promise<GetLogEventsResponse>
  // $METHODS_END
}
