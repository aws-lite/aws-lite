...
Import types from `@aws-lite/sns`. For plugin autoloading or string plugin names, add `import type {} from '@aws-lite/sns'` in TypeScript (or `import '@aws-lite/sns'` in JavaScript) to load the declarations.
