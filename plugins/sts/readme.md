...
Import types from `@aws-lite/sts`. For plugin autoloading or string plugin names, add `import type {} from '@aws-lite/sts'` in TypeScript (or `import '@aws-lite/sts'` in JavaScript) to load the declarations.
