...
Import types from `@aws-lite/apigatewayv2`. For plugin autoloading or string plugin names, add `import type {} from '@aws-lite/apigatewayv2'` in TypeScript (or `import '@aws-lite/apigatewayv2'` in JavaScript) to load the declarations.
