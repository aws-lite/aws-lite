...
export default {
  ...
  DeleteFunctionConcurrency:          { disabled, awsDoc: docRoot + 'API_DeleteFunctionConcurrency.html' },
  ...
  PutFunctionConcurrency:             { disabled, awsDoc: docRoot + 'API_PutFunctionConcurrency.html' },
