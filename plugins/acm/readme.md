...
Import types from `@aws-lite/acm`. For plugin autoloading or string plugin names, add `import type {} from '@aws-lite/acm'` in TypeScript (or `import '@aws-lite/acm'` in JavaScript) to load the declarations.
