...
export default {
  ...
  CreateBucket:                                { disabled, awsDoc: docRoot + 'API_CreateBucket.html' },
  ...
  DeleteBucket:                                { disabled, awsDoc: docRoot + 'API_DeleteBucket.html' },
  ...
  DeleteObject:                                { disabled, awsDoc: docRoot + 'API_DeleteObject.html' },
  DeleteObjects:                               { disabled, awsDoc: docRoot + 'API_DeleteObjects.html' },
  ...
  GetBucketEncryption:                         { disabled, awsDoc: docRoot + 'API_GetBucketEncryption.html' },
  ...
  HeadBucket:                                  { disabled, awsDoc: docRoot + 'API_HeadBucket.html' },
