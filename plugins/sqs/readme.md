...
Import types from `@aws-lite/sqs`. For plugin autoloading or string plugin names, add `import type {} from '@aws-lite/sqs'` in TypeScript (or `import '@aws-lite/sqs'` in JavaScript) to load the declarations.
