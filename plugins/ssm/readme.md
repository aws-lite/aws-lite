...
Import types from `@aws-lite/ssm`. For plugin autoloading or string plugin names, add `import type {} from '@aws-lite/ssm'` in TypeScript (or `import '@aws-lite/ssm'` in JavaScript) to load the declarations.
