...
esbuild vendor-aws-json-entry.mjs --bundle --platform=node --format=cjs --outfile=../../src/_vendor/aws.js --banner:js="$aws_json_comment"
...
esbuild vendor-xml-entry.js --bundle --platform=node --format=cjs --outfile=../../src/_vendor/xml.js --minify --banner:js="$xml_comment"
